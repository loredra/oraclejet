...
define(['knockout'],
        function (ko)
        {
            ...
            self.previousFilterType = ko.observableArray([]);
            var oldSizeTreeCountry, oldPosTreeCountry, oldPosTreeList, oldSizeTreeList, oldPosTreeType, oldSizeTreeType;
            ...
            function rememberState(name, filterTreeCountry, filterTreeList, filterTreeType) {
                ...
                if (filterTreeType === undefined)
                    self.previousFilterType([""]);
                else
                    self.previousFilterType(filterTreeType);
            }
            ...
            function resetState() {
                ...
                previous.push(self.previousFilterType());
                return previous;
            }
            

            function rememberPositionTrees(sizeTreeCountry, posTreeCountry, sizeTreeList, posTreeList, sizeTreeType, posTreeType) {
                oldSizeTreeCountry = sizeTreeCountry;
                oldPosTreeCountry = posTreeCountry;
                oldSizeTreeList = sizeTreeList;
                oldPosTreeList = posTreeList;
                oldSizeTreeType = sizeTreeType;
                oldPosTreeType = posTreeType;
            }
            ...
            function resetTreesPos() {
                ...
                previousTreePos.push(oldSizeTreeType);
                previousTreePos.push(oldPosTreeType);
